...
class MeterReadingAdmin(admin.ModelAdmin):
    list_display = (
        "unit", "organization", "meter_type", "period_month",
        "previous_reading", "current_reading", "units_consumed", "status",
    )
    ...
    fieldsets = (
        ...
        ("Values", {"fields": ("previous_reading", "current_reading", "units_consumed", "ocr_extracted_value")}),
